<#
	.SYNOPSIS
		Get-EVVersion10_11.ps1 stable on 03/21/2017 Detect if either Agent or Vault log format and extract essential information for ticket documenting
		Bug in other language Agent log backup_fr.xlog.log
	...
	.INPUTS
		Evault Agent or Vault backup/restore/synch logs in text format
